		...
		<iZbs_DokVseb:Header>
			...
			<iZbs_Zaglavje:IdSporocila>
				...
				<iZbs_Spl:DavcnaStevilka>
					...
					<iZbs_Spl:Drzava>
						<xsl:call-template name="iso3ATo2NCode">
							<xsl:with-param name="code" select="$C3A"/>
						</xsl:call-template>
					</iZbs_Spl:Drzava>
					<iZbs_Spl:Vrednost>
			...
			<iZbs_Zaglavje:PrejemnikSporocila>
				...
				<iZbs_Spl:DavcnaStevilka>
					<iZbs_Spl:Drzava>
						<xsl:call-template name="iso3ATo2NCode">
							<xsl:with-param name="code" select="$C3APrejemnik"/>
						</xsl:call-template>
					</iZbs_Spl:Drzava>
					<iZbs_Spl:Vrednost>
 ...
 ************************************ -->
	<xsl:template match="izv:Naslov">
		<iZbs_Spl:Naslov>
			...
			<iZbs_Spl:Drzava>
				<xsl:call-template name="iso3ATo2NCode">
					<xsl:with-param name="code" select="$UpnC3A"/>
				</xsl:call-template>
...
-->
	...
	<xsl:template name="iso3ATo2NCode">
		<xsl:param name="code"/>
		<xsl:value-of select="$ISOCountryCode/ISOCountryCodes/ISO3166[@a3 = $code]/@a2"/>
	</xsl:template>
</xsl:stylesheet>
